...
// ADAM 2014-11-10: changed inline functions to be declared and
// defined as "static inline" to improve compatibility with C99; details
// here: http://www.greenend.org.uk/rjk/tech/inline.html
...
static inline uint32_t		mts_lrand(mt_state* state);
					/* Generate 32-bit value, any gen. */
#ifdef UINT64_MAX
static inline uint64_t		mts_llrand(mt_state* state);
					/* Generate 64-bit value, any gen. */
#endif /* UINT64_MAX */
static inline double		mts_drand(mt_state* state);
					/* Generate floating value, any gen. */
					/* Fast, with only 32-bit precision */
static inline double		mts_ldrand(mt_state* state);
					/* Generate floating value, any gen. */
					/* Slower, with 64-bit precision */

static inline uint32_t		mt_lrand(void);	/* Generate 32-bit random value */
#ifdef UINT64_MAX
static inline uint64_t		mt_llrand(void);
					/* Generate 64-bit random value */
#endif /* UINT64_MAX */
static inline double		mt_drand(void);
					/* Generate floating value */
					/* Fast, with only 32-bit precision */
static inline double		mt_ldrand(void);
					/* Generate floating value */
					/* Slower, with 64-bit precision */
...
#define MT_EXTERN // ADAM: C99 does NOT allow "extern inline" header definitions
#endif /* __cplusplus */
#endif /* MT_EXTERN */
 ...
 */
static inline uint32_t mts_lrand(
 ...
 */
static inline uint64_t mts_llrand(
    register mt_state*	state)		/* State for the PRNG */
    {
 ...
 */
static inline double mts_drand(
    register mt_state*	state)		/* State for the PRNG */
    {
    register uint32_t	random_value;	/* Pseudorandom value generated */
 ...
 */
static inline double mts_ldrand(
    register mt_state*	state)		/* State for the PRNG */
    {
#ifdef UINT64_MAX
 ...
 */
static inline uint32_t mt_lrand(void)
    {
    register uint32_t	random_value;	/* Pseudorandom value generated */
