...
customCurveProp{1}.DisplayName = 'Small Subvolumes';
customCurveProp{2}.LineStyle = '-';
customCurveProp{2}.DisplayName = 'Large Subvolumes';
customCurveProp{1}.Color = 'k';
customCurveProp{2}.Color = 'r';

numPlot = length(passiveID);
%% Call accordPlotMaker
for p = 1:numPlot
    [~,hAxes] = accordPlotMaker(hAxes, fileToLoad,...
        passiveID(p), molID, ...
