...
%% Set Default Values
obsSpec = struct('obsType', 'Sample', ...           % Type of data to plot. Options are 'Sample', 'Empirical CDF', and 'Histogram'
    'numHistBins', 100, ...                         % # of histogram bins if obsType == 'Histogram'
